...
export const Header = ({ showButtons }: { showButtons: boolean }) => {
  ...
  return (
    <nav className="sticky top-0 z-50 flex w-full items-center h-14 justify-between bg-custom-gradient p-2 text-white sm:p-6 md:flex md:justify-between md:items-center">
      {/* Vineo Logo */}
      <div className="flex items-center flex-shrink-0">
        <img src="/images/logo.png" alt="Vineo Logo" className="w-32 sm:w-15 md:w-32" />
      </div>
