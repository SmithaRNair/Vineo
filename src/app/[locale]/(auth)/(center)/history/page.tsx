...
//       <h2 className="text-lg font-semibold">{t('Historia de la caja de vino')}</h2>
//       <div className="my-4">
//         <input
//           type="text"
//           placeholder="Buscar..."
...
//             <tr>
//               <th className="p-2 text-left sm:px-4">{t('Detalles del usuario')}</th>
//               <th className="p-2 text-left sm:px-4">{t('Vino en caja')}</th>
//               <th className="p-2 text-left sm:px-4">{t('Fecha de creación del cuadro')}</th>
//               <th className="p-2 text-left sm:px-4">{t('Fecha de entrega de la caja')}</th>
//               <th className="p-2 text-left sm:px-4">{t('Tipo de caja')}</th>
//               <th className="p-2 text-left sm:px-4">{t('Status')}</th>
//               <th className="p-2 text-left sm:px-4">{t('Comportamiento')}</th>
//             </tr>
//           </thead>
//           <tbody>
//             {boxes.length > 0 ? (
...
//                   </td>
//                   <td className="p-2 text-green-500 sm:px-4">{t('Entregable')}</td>
//                   <td className="p-2 text-red-500 sm:px-4">{t('Rechazada')}</td>
